...
upload_repo_id = "wanghh2000/bert-finetune"
upload_repo_branch = "v1"

r = Repository(
    repo_id=upload_repo_id,
    upload_path=outputDir,
    user_name="wanghh2000",
    token=access_token,
    repo_type="model",
    branch_name=upload_repo_branch,
)
r.upload()
print(f"upload model to {upload_repo_id} :{upload_repo_branch}")
